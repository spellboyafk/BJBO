    ...
    <div class="container-fluid py-3">
        <div class="row align-items-center">
            ...
            <div class="col-2">
                <div class="main-logo">
                    <a href="{{ url('/') }}">
                        <img src="{{ asset('images/logo-bjbo.png') }}" alt="logo" class="img-fluid" style="max-height: 50px;">
                    </a>
                </div>
            </div>
  ...
  <body>
    ...
    <a href="{{ route('paket.buah') }}" class="nav-link d-flex align-items-center gap-3 text-dark p-2">
        ...
        <span>Paket Buah</span>
          ...
          <li class="nav-item border-dashed">
              <a href="{{ route('mitra.toko') }}" class="nav-link d-flex align-items-center gap-3 text-dark p-2">
                  <svg width="24" height="24" viewBox="0 0 24 24">
